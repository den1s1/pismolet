...
public static class MailingConfirmationSubmitOverlayEndpoints
{
    public static IEndpointRouteBuilder MapMailingConfirmationSubmitOverlayEndpoints(this IEndpointRouteBuilder app)
    {

...
public static class HtmlRenderer
{
    ...
    public static string AccountForm(string action, string title, bool name, bool password = true, bool registrationConsents = false)
    {
        ...
        var consentFields = registrationConsents
            ? "<div class='form-consents'><label><input type='checkbox' name='acceptOffer' value='true' required> Принимаю <a href='/legal/offer'>правила и оферту сервиса</a>.</label><label><input type='checkbox' name='acceptPrivacy' value='true' required> Даю согласие на обработку персональных данных согласно <a href='/legal/privacy'>политике обработки персональных данных</a>.</label></div>"
            : string.Empty;

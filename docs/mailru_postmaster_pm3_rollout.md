...
- [ ] Привести страницу `/admin/deliverability/mailru` к единому административному каркасу: на самой странице отсутствует боковое меню, хотя пункт «Доставляемость Mail.ru» в общем административном меню присутствует один раз.
